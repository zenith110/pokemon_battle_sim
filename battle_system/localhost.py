                ...
                if(len(player.pokemon_fainted) <= 0 and len(opponent.pokemon_fainted) <= 0):
                    ...
                    # Logic check for the opponent pokemon 
                        ...
                        if start_rec.collidepoint(mouse_pos):
                            carryOn = False
                            pokemon_player_battle_state(player.pokemon_in_use[0], opponent.pokemon_in_use[0], screen, screenB)
...
def start_game(player, opponent, rpc):
    ...
    status_screen_state(player, opponent, screen, status_screen, rpc, screenB)
