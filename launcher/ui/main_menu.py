...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(130, 30, 71, 16))
        self.label.setObjectName("label")
        self.time_played = QtWidgets.QLabel(self.centralwidget)
        self.time_played.setGeometry(QtCore.QRect(190, 30, 121, 21))
        self.time_played.setText("")
        self.time_played.setObjectName("time_played")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QtWidgets.QApplication.translate("MainWindow", "Time played:", None, -1))
